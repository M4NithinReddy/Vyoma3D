...
export const posts = [
  ...
  { id: 3, title: 'Material Selection Guide for SLA 3D Printing', excerpt: 'Compare properties of standard, tough, flexible, and engineering resins to choose the right material for your application.', author: 'Dr. Emily Watson', date: '2025-09-25', readTime: '6 min', tags: ['Materials', '3D Printing'], image: 'https://res.cloudinary.com/dqnmk3s8t/image/upload/v1760971951/Generated_Image_October_20_2025_-_8_21PM_1_lij6lj.png' }
];
