      ...
      <div className="section-padding">
        <div className="container mx-auto container-padding">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
            ...
            <Card>
              <MapPin className="text-violet-400 mb-3" size={32} />
              <h3 className="font-bold text-white mb-2">Bengaluru Branch</h3>
              <p className="text-gray-400">
                302, 2nd Main Rd, Padmeshwari Nagar<br />
                Battarahalli, Kithiganur<br />
                Bengaluru, Karnataka 560049
              </p>
            </Card>

            <Card className="md:col-span-2 bg-gradient-to-br from-violet-500/10 to-cyan-500/10 border-violet-500/20">
